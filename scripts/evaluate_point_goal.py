...
from envs.pybullet.point_goal_env import BioloidEnvPointGoal, NavigationCommands
...
def main():
    ...
    try:
        agent = load_point_goal_agent(r"models\pybullet\sac\Point_goal.pth", env, device) # Hardcoded to use Point_goal.pth
