...
def main():
    ...
    try:
        walker_agent = load_agent_from_checkpoint(r"models\pybullet\sac\Walker.pth", env, device)
        turn_left_agent = load_agent_from_checkpoint(r"models\pybullet\sac\Left_Turner.pth", env, device)
        turn_right_agent = load_agent_from_checkpoint(r"models\pybullet\sac\Right_Turner.pth", env, device)
