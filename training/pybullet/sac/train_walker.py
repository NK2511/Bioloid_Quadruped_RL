...
from envs.pybullet.quadruped_env import BioloidAntLikeEnv
...
def parse_args():
    ...
    p.add_argument("--save-dir", type=str, default="journal_paper/walker/checkpoints")
    p.add_argument("--log-dir", type=str, default="journal_paper/walker/runs")
    p.add_argument("--checkpoint-interval", type=int, default=50, help="Every N episodes, save a full checkpoint (0=disabled)")
    p.add_argument("--checkpoint-dir", type=str, default="journal_paper/walker/checkpoints", help="Directory to store full checkpoints (defaults to save-dir)")
