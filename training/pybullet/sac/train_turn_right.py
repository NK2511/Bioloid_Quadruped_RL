...
from envs.pybullet.turn_right_env import BioloidAntLikeEnvTurnOnly
...
def parse_args():
    ...
    p.add_argument("--save-dir", type=str, default="journal_paper/turn_right/checkpoints")
    p.add_argument("--log-dir", type=str, default="journal_paper/turn_right/runs")
    p.add_argument("--checkpoint-interval", type=int, default=50, help="Every N episodes, save a full checkpoint (0=disabled)")
    p.add_argument("--checkpoint-dir", type=str, default="journal_paper/turn_right/checkpoints", help="Directory to store full checkpoints (defaults to save-dir)")
...
def main():
    ...
    env = BioloidAntLikeEnvTurnOnly(render_mode="DIRECT")
...
def evaluate_policy(agent, episodes=5):
    env_eval = BioloidAntLikeEnvTurnOnly(render_mode="DIRECT")
    total = 0.0
