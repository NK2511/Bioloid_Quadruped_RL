...
def main():
    ...
    parser.add_argument("--save-dir", type=str, default="output/mujoco/checkpoints_turn_right")
    parser.add_argument("--log-dir", type=str, default="output/mujoco/runs_turn_right")
    ...
    env = BioloidMujocoTurnRightEnv(xml_path=args.model_path)
